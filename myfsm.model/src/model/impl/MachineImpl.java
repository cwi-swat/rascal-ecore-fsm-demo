 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.MachineImpl#getStates <em>States</em>}</li>
 *   <li>{@link model.impl.MachineImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MachineImpl extends MinimalEObjectImpl.Container implements Machine {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MACHINE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.MACHINE__STATES:
				return getStates();
			case ModelPackage.MACHINE__NAME:
				return getName();
		}
